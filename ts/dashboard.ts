type Produto = {
    id: number;
    nome: string;
    preco: string; // vem como string pq o PDO devolve DECIMAL assim, tipo "299.99"
    estoque: number;
    vendas: number;
...
function calcularFaturamentoTotal(produtos: Produto[]): number {
...
function renderizarDashboard(produtos: Produto[]): void {
...
function mostrarErroNaTela(): void {
...
//acho que é isso vou continuar arrumando até o projeto chegar
